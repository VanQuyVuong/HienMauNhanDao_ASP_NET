...
export default function AboutPage() {
  // Nếu có xử lý logic ở đây, chúng ta cũng sẽ dùng biến tiếng Việt camelCase.
  // Hiện tại đây là một trang thông tin tĩnh kết hợp FAQ động bằng HTML5 <details>
  return (
