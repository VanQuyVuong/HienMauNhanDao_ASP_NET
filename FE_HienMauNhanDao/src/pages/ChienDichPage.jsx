...
export default function ChienDichPage() {
    ...
    return (
        <main className="flex-1 w-full max-w-[1200px] mx-auto p-4 md:p-8 mt-2 sm:mt-8 bg-white md:border md:border-slate-200 rounded-2xl shadow-sm mb-16">
            <div className="mb-8">
            ...
            {/* Filter Bar */}
            <div className="w-full bg-white p-4 sm:p-6 rounded-2xl border border-slate-200 mb-8 shadow-sm">
                ...
                <div className={`${showMobileFilter ? 'block' : 'hidden'} md:flex md:flex-row md:items-end gap-4 mt-4 md:mt-6 pt-4 md:pt-0 border-t border-slate-100 md:border-none space-y-4 md:space-y-0`}>
                    ...
                    <button
                        ...
                        className="w-full md:w-[160px] h-[42px] bg-red-700 text-white rounded-md font-bold text-sm hover:bg-red-800 flex items-center justify-center gap-2 shadow-lg shadow-red-700/20 active:scale-[0.98] transition-all"
                    >
            ...
            <div id="campaignGrid" className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-opacity duration-300">
                {paginatedCampaigns.map((campaign) => {
                    ...
                    return (
                        <div key={campaign.maChienDich} className="w-full h-auto min-h-[460px] bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-xl transition-all flex flex-col group pb-4">
                            {/* Image */}
