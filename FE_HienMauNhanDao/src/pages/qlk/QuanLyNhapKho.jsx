    ...
    const handleImport = async () => {
        ...
        try {
            ...
            if (res.data?.success) {
                ...
                fetchBloodUnits(); // Cập nhật danh sách túi máu
            }
        } catch (err) {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Khu vực Quét Mã & Xử lý */}
                    ...
                    {!tuiMau ? (
                        <div className="h-full flex flex-col items-center justify-center text-slate-400 gap-3 min-h-[250px] relative z-10">
                ...
                <div className="flex-[2] bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col h-[500px]">
                    {!selectedKho ? (
